...
class SiteSettingSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $customDefaultValues = [
            ...
            'contact_hours_primary' => 'Senin–Jumat 09.00–17.00 WIB',
            'contact_hours_primary_note' => 'Balasan tercepat via WhatsApp & email. Di luar jam kerja silakan tinggalkan pesan, tim kami akan follow-up maksimal keesokan harinya.',
            'contact_hours_secondary' => 'Sabtu 09.00–13.00 WIB',
            'contact_hours_secondary_note' => 'Tim siaga untuk koreksi data urgent & admin event.',
